import os
import datetime
from helpers.config import MAIL_PROFILE, MAIL_SVR, DATA_EXFILTRATION_SIZE, PHISHING_IOC_SUBJ, PHISHING_IOC_BODY, PHISHING_CAMPAIGN_DOMAIN, PHISHING_CAMPAIGN_BODY
